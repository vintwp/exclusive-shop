...
>(({ className, orientation, children, ...props }, ref) => (
  ...
  >
    {children}
    {orientation === 'horizontal' && <NavigationMenuViewport />}
  </NavigationMenuPrimitive.Root>
));
  ...
  >
    <NavigationMenuPrimitive.Viewport
      className={cn(
        ...
        rounded-md border border-neutral-200 bg-white text-neutral-950 shadow-lg
...
>(({ className, ...props }, ref) => (
  ...
  >
    <div
      className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-neutral-200 shadow-md
        dark:bg-neutral-800"
    />
  </NavigationMenuPrimitive.Indicator>
));
